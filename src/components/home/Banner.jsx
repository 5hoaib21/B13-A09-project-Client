  ...
  return (
    ...
    <section className=" grid  grid-cols-1 items-center gap-16 px-6 py-20 lg:grid-cols-2 lg:py-32">
      ...
      <div className="flex flex-col gap-8">
        {/* BADGE */}
        <div className="inline-flex w-fit items-center gap-2 rounded-full border border-[#434843]/20 bg-[#26392d]/30 px-4 py-1.5">
          <span className="text-[18px] text-[#ffb86a]">✦</span>

          <span className="text-sm text-[#c3c8c1]">Quiet rooms, on demand</span>
        </div>
        ...
        <p className="max-w-md text-lg leading-8 text-[#c3c8c1]">
          ...
          hour. List your own room and earn — without the scheduling headaches.
        </p>
